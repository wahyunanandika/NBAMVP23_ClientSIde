...
<template>
    <div class="flex flex-col top-0 left-0 w-80 bg-white h-full border-r">
        ...
        <div v-if="Object.keys(playerData2).length">
            <div class="flex items-center justify-center h-14 border-b">
            <img class="object-contain w-10 h-10" :src="playerData2.teamImageUrl" alt="">
            <p>
                {{ playerData2.name }}
            </p>
        </div>
        <div class="overflow-y-auto overflow-x-hidden flex-grow">
            <img class="object-contain" :src="playerData2.imageUrl">
            <ul class="flex flex-col py-4 space-y-1">
                <li class="px-5">
                    <div class="flex flex-row items-center h-8">
                        <div class="text-sm font-light tracking-wide text-gray-500">Team</div>
                ...
                <li>
                    <a href="#"
                        class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                        <span class="inline-flex justify-center items-center ml-4">
                            <img class="object-contain" :src="playerData2.teamImageUrl" alt="">
                            <!-- <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg> -->
                        </span>
                        <span class="ml-2 text-sm tracking-wide truncate">{{ playerData2.team }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">{{ playerData2.position }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">{{ playerData2.number }}</span>
                    </a>
                </li>
            </ul>
        </div>
